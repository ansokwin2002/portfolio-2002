<div class="header">
    <div class="container-fluid">
        <div class="navbar">
            ...
            <div class="box_menu">
                <ul>
                    <li><a href="#home" class="select_text">@lang('translate.home')</a></li>
                    <li><a href="#about">@lang('translate.about')</a></li>
                    <li><a href="#services">@lang('translate.services')</a></li>
                    <li><a href="#experience">@lang('translate.experience')</a></li>
                    <li><a href="#works">@lang('translate.works')</a></li>
                    <li><a href="#contact">@lang('translate.contact')</a></li>
                    <li><a href="{{ route('reancode') }}">@lang('translate.reancode')</a></li>
                </ul>
            </div>
